...
//         database.collection('deliveries').doc(id)
//         .set({requested: true}, {merge: true});
//     };
    
//     function addDeliveries(id) {
//         console.log('starting...');
//         database.collection('deliveries')
//         .where('pharmacy_id', '==', <%= current_pharmacy.id %>)
...
//         .get().then(function(docs) {
//             docs.forEach(function(doc) {
//                 var address = doc.data().recipient_address;
//                 var phone = doc.data().recipient_phone;
//                 var batch_id = doc.data().batch_id;
//                 var time = doc.data().delivery_time;
//                 var pharm_id = doc.data().pharmacy_id;
//                 var pharm_name = doc.data().pharmacy_name;
//                 updateDelivery(doc.id)
//                 updateRequestDeliveries(id, batch_id, address, phone, time, pharm_id, pharm_name);
//             });
//         });
//     };
    
//     function updateRequestDeliveries(request_id, batch_id, address, phone, time, pharm_id, pharm_name) {
//         database.collection('requests/'+ request_id + '/deliveries').add({
//             recipient_address: address,
//             recipient_phone: phone,
