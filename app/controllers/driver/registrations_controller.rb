class Driver::RegistrationsController < Devise::RegistrationsController
    ...
    def configure_permitted_parameters
        ...
        devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :number, :street, :town, :state, :zipcode, :license_plate, :car_make, :car_model, :car_year, :car_color])
    end
